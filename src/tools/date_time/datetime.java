...
public class datetime implements Comparable<datetime>
{
    ...
    */
    public datetime(int time_zone,boolean true_date_false_time)
    {
        ...
        year=true_date_false_time?now[0]:Integer.MIN_VALUE;
        month=true_date_false_time?now[1]:Integer.MIN_VALUE;
        day=true_date_false_time?now[2]:Integer.MIN_VALUE;
        hour=true_date_false_time?0:now[3];
        minute=true_date_false_time?0:now[4];
