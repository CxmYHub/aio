...
public class linked_list_singly
{
    ...
    */
    ...
    {
        int count=0;
        for(linked_list_singly pin=next;pin!=null;pin=pin.next,count++);
        return count;
    }
    /**
    <p>元素获取</p><br>
    ...
    */
    ...
    {
        int result=0;
        for(linked_list_singly pin=next;pin!=null;pin=pin.next,result++)
        {
    ...
    */
    public int[] traversal()
    {
        ...
        int i=0;
        for(linked_list_singly pin=next;pin!=null;pin=pin.next,i++)
        {
    ...
    */
    ...
    <p>区间元素删除</p><br>
    <p>此方法会修改调用对象。</p><br>
    删除单向链表中所有在[<code>min_element</code>,<code>max_element</code>]区间内的元素。
    ...
    */
    public int sort_ascend()
    {
        ...
        if(count>=2)
        {
            ...
            lists[0]=this;
            int pin=1;
            for(linked_list_singly list=next.next;list!=null;)
            {
