...
默认时区为东八区（UTC+8），可通过datetime.set_default_time_zone(int)方法改变。
*/
public class datetime implements Comparable<datetime>
{
    ...
    */
    ...
    如需使用年、月、日、时区构造日期时间对象，请在第五个参数中输入true。<br>
    此时构造的对象为纯日期对象，时、分、秒、毫秒均为0。<br>
    如需使用时、分、秒、时区构造日期时间对象，请在第五个参数中输入false。<br>
    此时构造的对象为纯时间对象，年、月、日均为Integer.MIN_VALUE。<br>
    @param year_hour 年或时。
    @param month_minute 月或分。
    @param day_second 日或秒。
    @param time_zone 时区。
    @param true_date_false_time 是否使用年、月、日、时区构造日期时间对象。<br>
    如需使用年、月、日、时区构造纯日期对象，请输入true。<br>
    如需使用时、分、秒、时区构造纯时间对象，请输入false。<br>
    */
    ...
    若参数无效，则使用默认时区（默认为东八区）当前日期时间。<br><br>
    如需使用年、月、日构造日期时间对象，请在第四个参数中输入true。<br>
    此时构造的对象为纯日期对象，时、分、秒、毫秒均为0。<br>
    如需使用时、分、秒构造日期时间对象，请在第四个参数中输入false。<br>
    此时构造的对象为纯时间对象，年、月、日均为Integer.MIN_VALUE。<br>
    @param year_hour 年或时。
    @param month_minute 月或分。
    @param day_second 日或秒。
    @param true_date_false_time 是否使用年、月、日构造日期时间对象。<br>
    如需使用年、月、日构造纯日期对象，请输入true。<br>
    如需使用时、分、秒构造纯时间对象，请输入false。<br>
    */
    ...
    */
    ...
    <p>此方法适用于纯日期对象和日期时间对象。</p><br>
    判断当前日期时间对象年份是否为闰年。
    @return 如果是闰年则返回true，否则返回false。<br>
    对于纯时间对象，返回false。
    */
    ...
    */
    ...
    若当前日期时间对象或指定日期时间对象为纯时间对象，返回Long.MIN_VALUE。
    */
